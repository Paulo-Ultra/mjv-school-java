...
public class ContratoTxtRepository {
    public Contrato buscar() {
        ...
        try {
            byte[] bytes = Files.readAllBytes(Paths.get("C:\\Users\\55619\\OneDrive\\Documentos\\MJV School - Java\\agua-luz-output", "agua-luz-contratos.txt"));
...
//            contrato.setTipoServico(TipoServico.getServicoPorSiglaconteudo.substring(177,178));
