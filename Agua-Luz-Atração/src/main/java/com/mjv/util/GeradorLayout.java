...
public class GeradorLayout {
    public String gerarDados(Cadastro cliente) {
        ...
        Contrato notificacao = cliente.getContrato();
        ...
        sb.append(String.format("%06d", Long.valueOf(endereco.getNumero())));
        ...
        sb.append(String.format("%08d", Long.valueOf(notificacao.getServico().getValor().toString().replaceAll("\\D", ""))));
